...
const menuItems = [
    { label: "Overview", icon: <ChartNoAxesColumn size={20} />, path: "/user/lele" },
    {
        label: "File Manager",
        icon: <Folder size={20} />,
        path: "/user/lele/filemanager",
    },
    { label: "Database", icon: <Database size={20} />, path: "/user/lele/database" },
    { label: "Setting", icon: <Settings size={20} />, path: "/user/lele/setting" },
];
        ...
        <div className="w-64 min-h-screen bg-white flex flex-col justify-between border-r">
            <div>
                <Link to="/" className="flex items-center gap-3 px-6 py-6">
                    <img src={ourhost} alt="ourhost logo" className="w-8 h-8" />
                    <span className="text-xl font-bold text-gray-800">ourhost</span>
                </Link>
